        ...
        <main className="layoutWrapper">
            ...
            <div>
                <aside className="news">
                    <img src="https://picsum.photos/100" className="mascot" alt="a placeholder image"/>
                ...
                <article className="mainContent"> 
                    ...
                    <p>Så släpp loss din inre otaku, vässa dina kontroller och förbered dig på att omfamna gemenskapen som bara ett evenemang som detta kan erbjuda. Låt oss tillsammans skapa en helg fylld av skratt, vänskap och spännande äventyr!</p><p>Så släpp loss din inre otaku, vässa dina kontroller och förbered dig på att omfamna gemenskapen som bara ett evenemang som detta kan erbjuda. Låt oss tillsammans skapa en helg fylld av skratt, vänskap och spännande äventyr!</p>
